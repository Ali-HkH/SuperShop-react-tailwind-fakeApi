...
function Contact() {
   return (
      <div className="container">
         ...
         {/* contact form */}
         <div>
            <h1 className="mb-8 text-[22px] font-bold text-stone-800">
               CONTACT FORM
            </h1>
            <form action="#" className="lg:pr-20">
               <div className="flex flex-col items-start gap-y-6 md:flex-row gap-x-10 mb-8">
                  <input
                     type="text"
                     placeholder="Name *"
                     className="w-full md:w-1/3 lg:w-1/4 py-3 px-5 text-lg font-medium text-stone-800 focus:outline-none focus:border-indigo-600 border border-gray-300 transition-all"
                  />
                  <input
                     type="email"
                     placeholder="Email *"
                  ...
                  <input
                     type="text"
                     placeholder="Website"
                     className="w-full md:w-1/3 lg:w-2/4 py-3 px-5 text-lg font-medium text-stone-800 focus:outline-none focus:border-indigo-600 border border-gray-300 transition-all"
                  />
               </div>
               <div>
                  <textarea
                     className="w-full min-h-40 mb-8 py-3 px-5 text-lg font-medium text-stone-800 focus:outline-none focus:border-indigo-600 border border-gray-300 transition-all"
